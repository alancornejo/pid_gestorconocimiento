...
|    |   |   |   |   |- plugin.min.js
*/
if($_SESSION['filemanager_categoria'] == "kdb"){
    $config = array(
            ...
            */
            ...
            |
            */
            'current_path' => '../../../../assets/images/KDB/',
            ...
            */
            ...
            'ext_misc'                                => array( 'zip', 'rar', 'gz', 'tar', 'iso', 'dmg' , 'msg', 'lnk', '7z' ), //Archives
            ...
            *******************/
            ...
            'hidden_folders'                          => array("BITACORAS"),
...
}else if($_SESSION['filemanager_categoria'] == "bitacora"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/BITACORAS/',
...
}elseif($_SESSION['filemanager_categoria'] == "borrador"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB_BORRADOR/',
...
}elseif($_SESSION['filemanager_categoria'] == "comunicado"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/COMUNICADOS/',
...
}elseif($_SESSION['filemanager_categoria'] == "comentario"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/COMENTARIOS/',
...
}elseif($_SESSION['filemanager_categoria'] == "ruta_horarios"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/RD/HORARIOS_RESPONSABLES/',
...
}elseif($_SESSION['filemanager_categoria'] == "ruta_turnos"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/RD/TURNOS/',
...
}elseif($_SESSION['filemanager_categoria'] == "ruta_speech"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/RD/SPEECH/',
...
}elseif($_SESSION['filemanager_categoria'] == "matriz_responsable"){
    $config = array(
            ...
            */
            ...
            |
            */
            'current_path' => '../../../../assets/images/KDB/RD/MATRIZ_RESPONSABLES/',
...
}elseif($_SESSION['filemanager_categoria'] == "matriz_jobs"){
    $config = array(
            ...
            */
            ...
            |
            */
            'current_path' => '../../../../assets/images/KDB/RD/MATRIZ_JOBS/',
...
}elseif($_SESSION['filemanager_categoria'] == "seguimiento_casos"){
    $config = array(
            ...
            */
            ...
            |
            */
            'current_path' => '../../../../assets/images/KDB/RD/SEGUIMIENTO_CASOS/',
...
}elseif($_SESSION['filemanager_categoria'] == "pregunta"){
    $config = array(
...
}elseif($_SESSION['filemanager_categoria'] == "pregunta_propuesta"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/EXAMEN/PROPUESTAS/',
...
}elseif($_SESSION['filemanager_categoria'] == "perfil_usuario"){
    $config = array(
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../assets/images/KDB/PERFIL/',
...
}elseif($_SESSION['filemanager_categoria'] == "portal_noticias"){
    $config = array(
      ...
      */
      ...
      |
      */
      'current_path' => '../../../../assets/images/PORTAL/NOTICIAS/',
