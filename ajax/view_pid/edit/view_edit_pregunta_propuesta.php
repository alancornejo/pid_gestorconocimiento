...
<?php
    ...
    $result_view = $object->view_pregunta_propuesta($id_pregunta);
                    ...
                    <div class="row">
                        <section class="col col-12">
                            ...
                            <div class="input-group">
                                <textarea name="nom_pregunta" rows="3" class="nom_pregunta editor_pregunta form-control"><?= $row_view['nombre_pregunta_pro'] ?></textarea>
                            </div>
                        </section>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <section class="col col-2">
                            ...
                            <div class="input-group">
                                ...
                                <input name="id_atu" type="text" class="id_atu form-control" id="inputIDEdit" value="" placeholder="'XXX'" maxlength="3" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.keyCode == 8">
                            </div>
                        </section>
