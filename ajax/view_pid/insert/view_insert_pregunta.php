...
<?php
    ...
    if($row_permisos['crea_pre_exam'] != "true"){
?>
<div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<?php }else{ ?>
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h3 class="modal-title">Insertar Pregunta</h3>
        </div>
        <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-7">
                            ...
                            <div class="input-group">
                                ...
                                <select name="sl_asignar[]" id="inputAsignar" class="sl_asignar selectpicker form-control show-tick" data-header="Asignar a Examen" data-live-search="true" data-selected-text-format="count" data-actions-box="true" multiple>
                    ...
                    <div class="row">
                        ...
                        <section class="col col-6">
                            ...
                            <div class="input-group">
                                ...
                                <select name="sl_aplicativo" id="inputAplicativoExam" class="sl_aplicativo selectpicker form-control show-tick" data-header="Aplicativo" data-live-search="true">
                                    <option value="" disabled selected>Selecciona Aqui</option>
                        ...
                        <section class="col col-4">
                            ...
                            <div class="input-group">
                                ...
                                <select name="sl_dificultad" id="inputDificultad" class="sl_dificultad selectpicker form-control show-tick" data-header="Dificultad">
                                  <option value="" disabled selected>Selecciona Aqui</option>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#insert_pregunta').submit(function( event ) {
            if ($(".respuesta_1").val() == "" || $(".respuesta_2").val() == "" || $(".respuesta_3").val() == "" || $(".respuesta_4").val() == "" || $(".nom_pregunta").val() == "" || $("select.sl_respuesta").val() == null || $("select.sl_asignar").val() == null || $("select.sl_aplicativo").val() == null || $(".id_atu").val() == "") {
                swal({
                    title: "",
                ...
                return false;
                    ...
                    swal({
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/action_class/examen/insert_pregunta.php",
                            data: datos,
