<?php
    ...
    $result_view = $object_view->view_grupo($id);
    $row = $result_view->fetch_assoc();
    /* Fin de Validar Grupo */
    
    /* Registro */
    $modelo_registro = "4";
    $tipo_registro = "4";
    $id_modelo = $_GET['id'];
    $contenido_registro = $row['nom_grupo'];
    $estado_registro = "";
    ...
    if($row_permisos['dele_grupo'] == "true"){
        if($result = $object->delete_grupo($id)){
            echo "true";
