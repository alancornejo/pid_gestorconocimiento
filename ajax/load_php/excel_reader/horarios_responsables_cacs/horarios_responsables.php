...
$result_view = $object_view->view_ruta_horarios_responsables_cacs();
$row_view = $result_view->fetch_assoc();
$file = $row_view['src_ruta'];
$ruta = explode("/", $file);
$ruta_excel = "../../../../assets/images/KDB/RD/HORARIOS_RESPONSABLES/".end($ruta);
...
<div class="panel panel-default bootcards-summary">
  <div class="panel-heading">
    <h3 class="panel-title">Horarios y Responsables Cac's</h3>
  </div>
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-4">
        <a class="bootcards-summary-item" target="_blank" href="visualizar_horarios_responsables/<?= $sheet ?>">
          <i class="fa fa-3x fa-file-excel-o"></i>
          <h5><?= utf8_encode($data->boundsheets[$sheet]['name']); ?> <span class="label label-primary"><i class="fa fa-eye"></i></span></h5>
        </a>
      </div>
      <?php } ?>
    </div>
